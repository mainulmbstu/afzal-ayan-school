    ...
    <div className="p-2">
      ...
      <div className=" grid md:grid-cols-12 gap-4">
        <div className="col-span-12 md:col-span-9">
          <h2 className=" font-bold mb-4">AFZAL-AYAN MODEL HIGH SCHOOL</h2>
          <p className="text-justify">
            AFZAL-AYAN MODEL HIGH SCHOOL is a premier educational institution
            dedicated to providing quality education and fostering holistic
            development in students. Our school is committed to nurturing young
            minds through innovative teaching methods, a supportive learning
            environment, and a strong emphasis on character building. <br />
